...
public class EntityFireGod extends AbstractGod{
    ...
    {
        EntityFireArrow entityarrow = this.getArrow(distanceFactor);
	...
	@Override
    protected EntityFireArrow getArrow(float p_190726_1_)
    {
        EntityFireArrow entitytippedarrow = new EntityFireArrow(this.world, this);
