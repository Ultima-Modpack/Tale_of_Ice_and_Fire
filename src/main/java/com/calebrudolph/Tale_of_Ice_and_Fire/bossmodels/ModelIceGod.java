...
public class ModelIceGod extends ModelBase {
    ...
    public ModelIceGod() {
        ...
        this.Hood = new ModelRenderer(this, 0, 16);
        ...
        this.Base2 = new ModelRenderer(this, 78, 0);
